...
for device_sn, (site_s, port_s) in device_site_dict.items():
    ...
    #            length_data = 0
        ...
        for site in site_s:
            ...
            ex_level_dat.loc[level_dat.index,site+'_level_in'] = level_dat[site+'_level_in']
            ex_temp_dat.loc[temp_dat.index,site+'_temp_F'] = temp_dat[site+'_temp_F']
            ex_cond_dat.loc[cond_dat.index,site+'_cond_mScm'] = cond_dat[site+'_cond_mScm']
